    ...
    if (!cbprefixed) {
        switch(instr) {
            ...
            case 0xb: // DEC BC  [----]
                ...
                break
            case 0xc: // INC C  [Z0H-]
                cpu.inc_reg16(R16.C)cpu.inc_reg8(R8.C)
                break
            case 0xd: // DEC C  [Z1H-]
                cpu.dec_reg8(R8.C)
                break
            ...
            case 0x70: // LD (HL) B [----]
                cpu.ld_valHL_r8(R8.B)
                break
            case 0x71: // LD (HL) C [----]
                cpu.ld_valHL_r8(R8.C)
                break
            case 0x72: // LD (HL) D [----]
                cpu.ld_valHL_r8(R8.D)
                break
            case 0x73: // LD (HL) E [----]
                cpu.ld_valHL_r8(R8.E)
                break
            case 0x74: // LD (HL) H [----]
                cpu.ld_valHL_r8(R8.H)
                break
            case 0x75: // LD (HL) L [----]
                cpu.ld_valHL_r8(R8.L)
                break
            case 0x76: // HALT   [----]
                cpu.halt()
                break
            case 0x77: // LD (HL) A [----]
                cpu.ld_valHL_r8(R8.A)
                break
